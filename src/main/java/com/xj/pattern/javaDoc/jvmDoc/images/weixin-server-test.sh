...
buildPath="ccr.ccs.tencentyun.com/lensung_wshop/order-test"
projectPath="/opt/respository/linshang_weixin_trade_new"

webPackage="/opt/respository/linshang_weixin_trade_new/web"
